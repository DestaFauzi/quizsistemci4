...
<body>
    <div class="container">
        <h1>Daftar Murid Materi: <?= esc($materi['judul']) ?></h1>
        ...
        <?php if (empty($muridMateriList)) : ?>
            <p class="no-data">Belum ada murid yang mengakses materi ini.</p>
        <?php else : ?>
            <div class="leaderboard-table-container">
                <table class="leaderboard-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <?php foreach ($muridMateriList as $murid) : ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                ...
                                <td>
                                    <?php
                                    // Sesuaikan badge berdasarkan status dari tabel materi_siswa
                                    if ($murid['status'] == 'selesai') {
                                        echo '<span class="badge badge-success">Selesai</span>';
                                    } elseif ($murid['status'] == 'sedang_dibaca') {
                                        echo '<span class="badge badge-primary">Sedang Dibaca</span>';
                                    } elseif ($murid['status'] == 'belum_diakses') {
                                        echo '<span class="badge badge-warning">Belum Diakses</span>';
                                    } else {
                                        echo '<span class="badge badge-secondary">' . esc($murid['status']) . '</span>';
                                    }
                                    ?>
                                </td>
                                <td><?= esc(date('d F Y H:i', strtotime($murid['waktu_akses']))) ?></td>
                                <td><?= esc(date('d F Y H:i', strtotime($murid['waktu_update']))) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
