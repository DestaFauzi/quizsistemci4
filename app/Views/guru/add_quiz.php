    ...
    <div class="container">
        ...
        <form action="<?= site_url('/guru/saveQuiz') ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul_quiz" id="judul_quiz" placeholder="Masukkan judul quiz" required>
            </div>

            <div class="form-group">
                <label for="jumlah_soal"><i class="fas fa-list-ol"></i> Jumlah Soal</label>
                <input type="number" name="jumlah_soal" id="jumlah_soal" min="1" placeholder="Jumlah soal dalam quiz" required>
            </div>

            <div class="form-group">
                <label for="waktu"><i class="fas fa-clock"></i> Waktu Pengerjaan (menit)</label>
                <input type="number" name="waktu" id="waktu" min="1" placeholder="Durasi quiz dalam menit" required>
            </div>
